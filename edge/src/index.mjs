...
const DISTRIBUTION_ASSETS = new Map([
  ...
  ["/.well-known/goldkey-guard/goldkey-enforcer-0.2.1.tgz", "application/gzip"],
  ["/.well-known/goldkey-guard/goldkey-enforcer-0.2.1.tgz.integrity.json", "application/json; charset=utf-8"],
]);
